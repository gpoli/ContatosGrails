...
<html>
    ...
    <body>
        ...
        <div id="show-contato" class="content scaffold-show" role="main">
            ...
            <f:display bean="contato" />
            <g:form resource="${this.contato}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.contato}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
